...
<body>
    ...
    <main>
        ...
        <% 
        Contact c1 = new Contact(); // 기본 생성자 호출
        c1.setId(1); // setter 메서드 호출
        c1.setName("홍길동");
        c1.setPhone("010-0000-0000");
        c1.setEmail("hgd@itwill.com");
        %>
        <p>
        ID: <%= c1.getId() %> <br/> <%-- getter 메서드 호출 (expression) --%>
        이름: <%= c1.getName() %> <br/>
        전화번호: <%= c1.getPhone() %> <br/>
        이메일: <%= c1.getEmail() %> <br/>
        </p>
        ...
        <jsp:useBean id="c2" class="com.itwill.lab04.model.Contact"></jsp:useBean>
        <%-- Contact c2 = new Contact(); --%>
        
        <jsp:setProperty property="id" name="c2" value="2"/>
        <%-- c2.setId(2); --%>
        
        <jsp:setProperty property="name" name="c2" value="오쌤"/>
        <jsp:setProperty property="phone" name="c2" value="010-1234-5678"/>
        <jsp:setProperty property="email" name="c2" value="jake@itwill.com"/>
        
        <p>
        ID: <jsp:getProperty property="id" name="c2"/> </br>
        <%-- c2.getId(); --%>
        
        이름: <jsp:getProperty property="name" name="c2"/> </br>
        전화번호: <jsp:getProperty property="phone" name="c2"/> </br>
        이메일: <jsp:getProperty property="email" name="c2"/> 
        </p>
