	...
	<div class="container-fluid">
		...
		<div class="card border-0">
			...
			<div class="card-header">
				...
				<small>${category_name[post.category]}</small> <input type="hidden"
				...
				<div class="d-flex justify-content-end mt-2">
					...
					<c:if
						...
						<form action="${postModifyPage}" method="get"
							...
							<button type="submit"
								class="btn btn-outline-primary btn-custom ms-2">️수정하기</button>
						</form>
			...
			<div class="btnList d-flex justify-content-between mt-2 mb-4"
				id="btnList">
