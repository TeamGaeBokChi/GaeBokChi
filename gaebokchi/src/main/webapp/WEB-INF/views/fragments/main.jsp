...
<body>
	...
	<section class="image-category container">
		...
		<ul class="row list-unstyled" id="clubCategory">
			...
			<li class="col-md-2 col-6">
				<div class="card text-center">
					<a href="/gaebokchi/mainPost/search?userid=&searchCategory=searchClubs&clubSelect=WG&textSearchSelect=&selectSelection=selectFalse"> <img src="images/웨지.png" class="card-img-top"
						alt="Category 2">
						<div class="card-body">
			...
			<li class="col-md-2 col-6">
				<div class="card text-center">
					<a href="/gaebokchi/mainPost/search?userid=&searchCategory=searchClubs&clubSelect=UT&textSearchSelect=&selectSelection=selectFalse"> <img src="images/유틸.png" class="card-img-top"
						alt="Category 3">
						<div class="card-body">
			...
			<li class="col-md-2 col-6">
				<div class="card text-center">
					<a href="/gaebokchi/mainPost/search?userid=&searchCategory=searchClubs&clubSelect=WD&textSearchSelect=&selectSelection=selectFalse"> <img src="images/우드.png" class="card-img-top"
						alt="Category 4">
						<div class="card-body">
			...
			<li class="col-md-2 col-6">
				<div class="card text-center">
					<a href=/gaebokchi/mainPost/search?userid=&searchCategory=searchClubs&clubSelect=PT&textSearchSelect=&selectSelection=selectFalse"> <img src="images/퍼터.png" class="card-img-top"
						alt="Category 6">
						<div class="card-body">
