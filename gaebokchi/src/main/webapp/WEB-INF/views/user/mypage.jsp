				...
				<div class="card">
					<div class="info_card">
                        ...
                        <div class="profile_management">
                            ...
                            <a href="${profile_management}"
                                                    class="btn_management btn active"
                                                    role="button"
                                                    aria-pressed="true">프로필
                                관리</a>
                        </div>
                        <div class="blank"></div>
                    </div>
				...
				<div class="card mt-4 p-4">
					<div class="shortcuts_icons">
                        ...
                        <c:if test="${signedInUser eq 'admin'}">
                            <div class="shortcuts_icon">
                                <c:url var="manageSite"
                                                            value="/admin/adminHome" />
