							...
							<form id="findIdForm">
								<div class="mb-1">
									<label for="findIdName" class="form-label">이름</label> <input
										type="text" class="form-control mb-1" id="findIdName"
										name="name" required>
								</div>
								<div class="mb-3">
									<label for="findIdEmail" class="form-control-label mt-2 mb-1">이메일</label>
									<input type="email" class="form-control mb-4" id="findIdEmail"
										name="email" required>
								</div>
								<button type="submit" class="btn w-100 text-center"
									id="findIdBtn">아이디 찾기</button>
							</form>
							<div id="findIdError" class="alert alert-danger mt-3"
								style="display: none;">
								<p id="errorMessage"></p>
							</div>
							...
							<form id="findPwForm">
								<div class="mb-3">
									<label for="findPwId" class="form-label">아이디</label> <input
										type="text" class="form-control" id="findPwId" name="userid"
										required>
								</div>
								<div class="mb-3">
								...
								<div class="form-group">
									...
									<div class="flex"
										...
										<select class="form-select" name="phone0" style="width: 30%;">
											...
											name="phone1" style="width: 20%;" required> <input
											type="text" class="form-control" id="phone2" name="phone2"
											placeholder="앞자리" required style="width: 25%;"> <input
											required type="text" class="form-control" id="phone3"
											name="phone3" placeholder="뒷자리" required style="width: 25%;">
									</div>
									<button type="submit" class="btn w-100 text-center mt-4"
										id="findPwBtn" name="findPwBtn">비밀번호 찾기</button>
								</div>
							</form>
							<!-- 새 비밀번호 설정 폼 (초기에는 숨김) -->
							<form id="setNewPwForm" style="display: none;" class="mt-3">
								<div class="mb-3">
									<label for="newPassword" class="form-label">새 비밀번호</label> <input
										...
										placeholder="8~15자의 숫자, 특수문자, 영문자 조합" name="password" required>
									<div id="passwordStrength"></div>
								</div>
								<div class="mb-3">
									<label for="userPasswordConfirm" class="form-label">새
										비밀번호 확인</label> <input type="password" class="form-control"
										id="userPasswordConfirm" placeholder="비밀번호를 다시 입력하세요" required>
									<div id="passwordMatch"></div>
								</div>
								<button type="submit" class="btn btn-primary" id="setNewPwBtn">새
									비밀번호 설정</button>
							</form>
							<!-- 오류 메시지 표시 영역 -->
							<div id="findPwError" class="alert alert-danger mt-3"
								style="display: none;">
