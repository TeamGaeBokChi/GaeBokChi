...
<head>
    ...
    <style>
        ...
        .btn-blind { background-color: #34495e; color: #fff; }
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>게시중</td>
                    <td>
                        <button class="btn btn-edit" onclick="editPost(1)">수정</button>
                        <button class="btn btn-delete" onclick="deletePost(1)">삭제</button>
                        <button class="btn btn-blind" onclick="blindPost(1)">블라인드</button>
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>골프장 리뷰: 제주 오션뷰 CC</td>
                    <td>김철수</td>
                    <td>2024-07-04</td>
                    <td>블라인드</td>
                    <td>
                        <button class="btn btn-edit" onclick="editPost(2)">수정</button>
                        <button class="btn btn-delete" onclick="deletePost(2)">삭제</button>
                        <button class="btn btn-blind" onclick="unblindPost(2)">블라인드 해제</button>
                    </td>
                </tr>
                <!-- 더 많은 게시글 행 추가 -->
            </tbody>
